  ...
  <nav class="sidebar">
    <ul class="sidebar-nav">
      <li class="home sidebar-item">
        <a href="./home.php" class="sidebar-link <?php if ($selectedPage == 'home') {
                                                    echo $sidebarLink;
                                                  } ?>">
      ...
      <li class="personal-info sidebar-item">
        <a href="./personal-info.php" class="sidebar-link <?php if ($selectedPage == "personal-info") {
                                                            echo $sidebarLink;
                                                          } ?>">
      ...
      <?php if ($isPlayer) { ?>
        <li class="player-info sidebar-item">
          <a href="./player-info.php" class="sidebar-link <?php if ($selectedPage == "player-info") {
                                                            echo $sidebarLink;
                                                          } ?>">
        ...
        <li class="team-overview sidebar-item">
          <a href="./team-overview.php" class="sidebar-link <?php if ($selectedPage == "team-overview") {
                                                              echo $sidebarLink;
                                                            } ?>">
      ...
      if ($isAdmin) {
      ?>
        <li class="players sidebar-item">
          <a href="../admin/players.php" class="sidebar-link">
      ...
      <li class="applications sidebar-item">
        <a href="./applications.php" class="sidebar-link <?php if ($selectedPage == "applications") {
                                                            echo $sidebarLink;
                                                          } ?>">
      ...
      <li class="choaching sidebar-item">
        <a href="../choaching/mycoachings.php" class="sidebar-link">
          <i class="fas fa-user-graduate sidebar-icon"></i>
          <span class="sidebar-text">Coaching</span>
        </a>
      </li>
